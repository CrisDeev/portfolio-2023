      ...
      <nav className="fixed w-full px-10 py-3 flex justify-between items-center backdrop-blur-md">
        ...
        <div>
          ...
          <div className='text-white hidden md:flex gap-6 font-semibold tracking-wide text-lg'>
            <a className='focus:text-[#3694ff] p-1 focus:border-b-[1px] focus:border-b-white hover:text-[#3694ff] transition-all duration-100' href='https://www.google.com' target='_blank' rel='noreferrer'>Sobre mi</a>
